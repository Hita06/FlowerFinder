...
class MockFlowerPhotoSource {
  ...
  static final photos = [
    SavedFlowerPhoto(
      image: _image('https://perenual.com/storage/image/page-image-asset/plant%202%20compress.png'),
      label: 'Daisy',
    ),
    SavedFlowerPhoto(
      image: _image('https://perenual.com/storage/image/page-image-asset/plant%203%20compress.png'),
      label: 'Lavender',
    ),
    SavedFlowerPhoto(
      image: _image('https://perenual.com/storage/image/page-image-asset/plant%204%20compress.png'),
      label: 'Sunflower',
    ),
  ];
}